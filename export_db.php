...
// Récupérer les informations sur les colonnes et les relations
$databaseStructure = [];
...
?>
    ...
    <div class="container">
        <h1 class="text-center">Structure de la base de données</h1>
        <div class="container">
    <p>Ce script PHP a été conçu pour fournir une vue d'ensemble de la structure de notre base de données MySQL, affichée dans un format HTML simple avec Bootstrap pour une meilleure lisibilité.</p>
    <ul class="list-group">
        <li class="list-group-item"><strong>Connexion à la base de données :</strong> Le script se connecte à la base de données en utilisant les identifiants définis dans le fichier <code>config.php</code>.</li>
        <li class="list-group-item"><strong>Récupération des tables :</strong> La requête <code>SHOW TABLES</code> récupère toutes les tables de la base de données.</li>
        <li class="list-group-item"><strong>Récupération des colonnes :</strong> La requête <code>SHOW COLUMNS FROM \$table</code> récupère les colonnes de chaque table.</li>
        <li class="list-group-item"><strong>Récupération des clés étrangères :</strong> La requête sur <code>INFORMATION_SCHEMA.KEY_COLUMN_USAGE</code> récupère les clés étrangères de chaque table.</li>
    </ul>
</div>
