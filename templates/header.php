...
<?php
    if (isset($_SESSION['utilisateur'])) {
        // Afficher le pseudo et les crédits
        echo $_SESSION['utilisateur']['pseudo'] . " - Crédits : " . $_SESSION['utilisateur']['credits'];

        // Ajouter un bouton "Mon compte" qui renvoie à "mesInformations.php"
        echo ' <a href="monCompte.php" class="btn btn-primary">Mon compte</a>';
