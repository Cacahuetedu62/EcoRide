...
<?php
// Si l'utilisateur est un administrateur, afficher le bouton avec un SVG
if ($afficher_bouton_dashboard) {
    echo '<a href="adminDashboard.php" class="btn-dashboard">';
...
<?php 
if (isset($_SESSION['utilisateur']) && $type_acces !== 'administrateur'):
?>
