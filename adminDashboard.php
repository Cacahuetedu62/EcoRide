    ...
    <div class="row justify-content-center g-4">
        ...
        <div class="col-md-5">
            <div class="card dashboard-option shadow-lg border-0 h-100">
                <div class="card-body text-center p-5">
                    <div class="mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-people-fill text-success" viewBox="0 0 16 16" aria-label="Gestion des Utilisateurs">
                    ...
                    <a href="manage.php" class="btn btn-success btn-lg px-4 w-100 text-decoration-none" aria-label="Gérer les Utilisateurs">
